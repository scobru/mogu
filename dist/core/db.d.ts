...
export declare const serializeDatabase: (state: Map<string, EncryptedNode>, key: Uint8Array) => string;
export declare const deserializeDatabase: (json: string, key: Uint8Array) => Promise<Map<string, EncryptedNode> | undefined>;
export declare const deserializeDatabaseSdk: (json: string, key: Uint8Array, nonce: any) => Promise<Map<string, EncryptedNode> | undefined>;
export declare const storeDatabase: (state: Map<string, EncryptedNode>, key: Uint8Array) => Promise<any>;
export declare const retrieveDatabase: (hash: string, key: Uint8Array) => Promise<Map<string, EncryptedNode> | undefined>;
